...
data_file = "thesis_contact_resistance_v1.json"
output_dir = "./_qwen25_7b_qlora_cot"
...
peft_config = LoraConfig(
    ...
    lora_dropout=0.05, bias="none", task_type="CAUSAL_LM", use_dora=False
)
...
print(">>> Starting QLoRA Training (QLoRA CoT - 49 samples)...")
trainer.train()
